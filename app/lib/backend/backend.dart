...
import 'schema/serviceprovider_record.dart';
import 'schema/handyman_record.dart';
...
export 'schema/serviceprovider_record.dart';
export 'schema/handyman_record.dart';
...
/// Functions to query HandymanRecords (as a Stream and as a Future).
Future<int> queryHandymanRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      HandymanRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<HandymanRecord>> queryHandymanRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      HandymanRecord.collection,
      HandymanRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<HandymanRecord>> queryHandymanRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
