...
import '/provider_profile/why_me/why_me_widget.dart';
...
class ProfilesWidget extends StatefulWidget {
  ...
  final ServiceproviderRecord? provider;
                          ...
                          ToggleIcon(
                            onPressed: () async {
                              safeSetState(
                                () => FFAppState()
                                        .FavouriteProvider
                                        .contains(widget.provider?.displayName)
                                    ? FFAppState().removeFromFavouriteProvider(
                                        widget.provider!.displayName)
                                    : FFAppState().addToFavouriteProvider(
                                        widget.provider!.displayName),
                              );
                              if (true) {
                                FFAppState().removeFromFavouriteProvider('');
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: CachedNetworkImage(
                                    ...
                                    imageUrl: widget.provider!.photoUrl,
                                    fit: BoxFit.cover,
