        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              path: 'store',
              builder: (context, params) => params.isEmpty
                  ? const NavBarPage(initialPage: 'Store')
                  : const StoreWidget(),
            ),
            FFRoute(
              name: 'Profile',
            ...
            FFRoute(
              ...
              asyncParams: {
                'provider': getDoc(
                    ['serviceprovider'], ServiceproviderRecord.fromSnapshot),
              },
            ...
            FFRoute(
              name: 'Handyman',
              path: 'handyman',
              builder: (context, params) => const HandymanWidget(),
            ),
            FFRoute(
              name: 'Services',
              path: 'services',
              asyncParams: {
                'service': getDoc(['Service'], ServiceRecord.fromSnapshot),
                'serviceprovider': getDoc(
                    ['serviceprovider'], ServiceproviderRecord.fromSnapshot),
              },
              builder: (context, params) => ServicesWidget(
                ...
                serviceprovider: params.getParam(
                  'serviceprovider',
                  ParamType.Document,
                ),
              ),
            ...
            FFRoute(
              name: 'Providers',
              path: 'providers',
              builder: (context, params) => const ProvidersWidget(),
            ),
            FFRoute(
              name: 'FavProviders',
              path: 'FavProviders',
              builder: (context, params) => const FavProvidersWidget(),
            ),
            FFRoute(
              name: 'FavServices',
              path: 'FavServices',
              builder: (context, params) => const FavServicesWidget(),
            ),
            FFRoute(
              name: 'Blogs',
              path: 'blogpages',
            ...
            FFRoute(
              ...
              asyncParams: {
                ...
                'author': getDoc(['users'], UsersRecord.fromSnapshot),
              },
          ...
          final child = appStateNotifier.loading
              ? isWeb
                  ...
                  : Container(
                      ...
                      child: Center(
                        child: Image.asset(
                          'assets/images/onlyclick_logo.png',
                          height: 100.0,
                          fit: BoxFit.cover,
                        ),
                      ),
